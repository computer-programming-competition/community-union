...
#include "../SWJservice/tcpclientsocket.h"
...
QT_MOC_LITERAL(4, 38, 15), // "doFlushActivity"
QT_MOC_LITERAL(5, 54, 17), // "doFlushMemberList"
QT_MOC_LITERAL(6, 72, 7), // "loginOk"
QT_MOC_LITERAL(7, 80, 1), // "s"
QT_MOC_LITERAL(8, 82, 12), // "dataReceived"
QT_MOC_LITERAL(9, 95, 16) // "slotDisconnected"

    },
    "TcpClientSocket\0disconnected\0\0qintptr\0"
    "doFlushActivity\0doFlushMemberList\0"
    "loginOk\0s\0dataReceived\0slotDisconnected"
};
...
void TcpClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->doFlushActivity(); break;
        case 2: _t->doFlushMemberList(); break;
        case 3: _t->loginOk((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        {
            using _t = void (TcpClientSocket::*)(qintptr );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpClientSocket::doFlushActivity)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TcpClientSocket::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpClientSocket::doFlushMemberList)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (TcpClientSocket::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpClientSocket::loginOk)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 1
void TcpClientSocket::doFlushActivity()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void TcpClientSocket::doFlushMemberList()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void TcpClientSocket::loginOk(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
